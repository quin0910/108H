    ...
    <div class="row">
      ...
      <div class="col-md-12 order-md-1">
        ...
        <form class="needs-validation" method="POST" action="./index.php">
          ...
          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="applicant">申請人(輸入員工編號)</label>
          ...
          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="tcost">車馬費</label>
                  <input name="tcost" type="text" class="form-control" id="tcost" placeholder="" value="" >
                </div>
          </div>

          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="acost">住宿費</label>
                  <input name="acost" type="text" class="form-control" id="acost" placeholder="" value="" >
                </div>
          </div>
